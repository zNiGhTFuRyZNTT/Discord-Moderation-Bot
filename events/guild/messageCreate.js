...
module.exports = async (Discord, bot, msg) => {
  ...
  // media_mod_btns.components[0].setStyle("PRIMARY")
  // media_mod_btns.components[0].setLabel('Done!')
  // media_mod_btns.components[0].setDisabled(true) 
  ...
  if (msg.content.startsWith(prefix)) {
    ...
    try {
      ...
      msg.attachments.map(attachment => {
        ...
        if ( ['video/quicktime', 'video/mp4'].indexOf(attachment.contentType) >= 0 ) {
          mediaLogChannel.send(`Sent By <@!${msg.author.id}> \n${attachment.url}`)
          mediaLogChannel.send(`https://media.discordapp.net/attachments/818028244916895744/936594581296930877/20210510_185705.gif`)
          return
        }
          ...
          log_media(mediaLogChannel, msg.author.id, attachment.url, media_mod_btns)
          mediaLogChannel.send(`https://media.discordapp.net/attachments/818028244916895744/936594581296930877/20210510_185705.gif`)
          return
        }
      })
